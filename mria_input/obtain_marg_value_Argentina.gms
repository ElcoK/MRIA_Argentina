...
set
S(col) list of industries  /A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P/
         rROW(reg) The region subset plus ROW for the cost estimation
/Ciudad_de_Buenos_Aires,Buenos_Aires,Catamarca,Cordoba,Corrientes,Chaco,Chubut,Entre_Rios,Formosa,Jujuy,La_Pampa,La_Rioja,Mendoza,Misiones,Neuquen,Rio_Negro,Salta,San_Juan,San_Luis,Santa_Cruz,Santa_Fe,Santiago_del_Estero,Tucuman,Tierra_del_Fuego/
...
Xmarg(R,S)=X.M(R,S);
option NLP=conopt4;
SOLVE LPIODisMarg minimizing Z using NLP;
Xmarg(R,S)=X.M(R,S);
