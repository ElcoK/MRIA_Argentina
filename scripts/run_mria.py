...
def estimate_losses(input_file):
    ...
    df_failures[df_failures <= 0.5] = 0.5 # <--- import bit! In some cases there might be a 100% reduction in flows. 
                                #Model can become instable with 100% reduction of flows, so we assume max reduction of 50%. 
